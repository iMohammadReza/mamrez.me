...
export interface TextRevealProps {
  text: string | string[];
  as?: ElementType;
  /** Forwarded to the root element (local addition, e.g. for aria-labelledby targets). */
  id?: string;
  className?: string;
  split?: SplitMode;
  stagger?: number;
 ...
 */
export function toWordGroups(line: string): WordGroup[] {
...
export function TextReveal({
  ...
  return (
    <Comp ref={ref} id={id} className={cn('block', className)}>
      {lines.map((line) => {
